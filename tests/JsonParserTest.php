...
class JsonParserTest extends TestCase {
    ...
    public function testParseAll() {
        ...
        $expectedProjects = array(
            new Project(1,"Thing","You know you need it.",50,80,"2016/12/11","http://example.com/thing"),
            new Project(2, "Cat Cookies", "Heaven is bacon-flavored.",60,45,"2016/12/11","http://example.com/cat_cookies")
        );
